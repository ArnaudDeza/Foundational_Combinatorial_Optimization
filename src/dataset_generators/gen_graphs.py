...
from src.dataset_generators.utils__rb_graphs import get_random_instance as get_random_instance_RB
...
def gen_dai_paper_datasets(base_folder, num_graphs_to_generate = 10000):
    ...
    for mode in ["er", "ba"]:
        for i in [1, 2, 3, 4, 5, 6, 7]:
            ...
            if mode == "er":
                python_cmd = f"python /storage/home/hcoda1/3/adeza3/scratch/foundationalCO/src/dataset_generators/mis/main.py gendata random dummy {folder} --model er --min_n {min_n} --max_n {max_n} --num_graphs {num_graphs_to_generate} --er_p 0.15"
            else:
                python_cmd = f"python /storage/home/hcoda1/3/adeza3/scratch/foundationalCO/src/dataset_generators/mis/main.py gendata random dummy {folder} --model ba --min_n {min_n} --max_n {max_n} --num_graphs {num_graphs_to_generate} --ba_m 4"
...
if __name__ == "__main__":
    ...
    base_folder = '/storage/home/hcoda1/3/adeza3/p-phentenryck3-1/adeza3/foundationalCO/data/synthetic/graphs'

    # query user if they want to delete the folder
    if os.path.exists(base_folder):
        ...
        if delete == "y":
            ...
            print(f"Folder {base_folder} not deleted.")
            exit()
    ...
    print("ER paper datasets generated.")
    ##############################################
    ##############################################
    ...
    print("RB paper datasets generated.")
    ##############################################
